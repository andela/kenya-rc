      ...
      <div className="rui search-modal-sort-filter-container">
        <div className="row">
          <div className="col-md-4 col-xs-12 select-field">
            <div>
              <label className="dropdown-tag">Vendor:</label>
            </div>
              ...
              >
                ...
                {vendors &&
                  vendors.map((vendor, index) => (
                    <option key={index.toString()} value={vendor}>
                      {vendor}
                    </option>
                  ))}
              </select>
          ...
          <div className="col-md-4 col-xs-12 select-field">
            <div>
              <label className="dropdown-tag">Price:</label>
            </div>
            <div className="rui select">
              <select id="price-filter" className="price-filter" onChange={() => this.props.handlePriceFilter("price-filter")}>
          ...
          <div className="col-md-4 col-xs-12 select-field">
            <div>
              <label className="dropdown-tag">Sort By:</label>
            </div>
            <div className="rui select">
              <select id="sort-result" className="sort-result" onChange={() => this.props.handleSort("sort-result")}>
